...
public class ByteBuddyProxyFactory implements ProxyFactory, Serializable {
	...
	public static Class buildProxy(
		...
		proxy = new ByteBuddy()
				...
				.intercept( FieldAccessor.ofField( "$$_hibernate_interceptor" ).defineAs( ByteBuddyInterceptor.class, Visibility.PRIVATE ) )
				.make()
	...
	public HibernateProxy getProxy(
		...
		try {
			...
			( (ProxyObject) proxy ).$$_set_hibernate_interceptor( interceptor );
