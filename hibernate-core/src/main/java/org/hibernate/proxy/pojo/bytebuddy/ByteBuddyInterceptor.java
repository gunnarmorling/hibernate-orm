...
public class ByteBuddyInterceptor extends BasicLazyInitializer {
	...
	public static Object intercept(
			...
			@Origin final Method thisMethod,
			@StubValue final Object stubValue,
			@AllArguments final Object[] args,
			@FieldValue("$$_hibernate_interceptor") ByteBuddyInterceptor interceptor) throws Throwable {
		if ( interceptor == null ) {
